      ...
      <div className="flex justify-between px-24 py-12">
        ...
        <div className="flex gap-x-16">
          <div className="font-light space-y-2">
            ...
            <h1 className="hover:font-normal cursor-pointer">Postdoc Section</h1>
            <h1 className="hover:font-normal cursor-pointer">Companies</h1>
          </div>

          <div className="font-light space-y-2">
            <h1 className="font-medium">For Employers</h1>
            <h1 className="hover:font-normal cursor-pointer">Events</h1>
            <h1 className="hover:font-normal cursor-pointer">Recruitment</h1>
            <h1 className="hover:font-normal cursor-pointer">Talent Pool</h1>
          </div>

          <div className="font-light space-y-2">
            <h1 className="font-medium">Company</h1>
            <h1 className="hover:font-normal cursor-pointer">About us</h1>
            <h1 className="hover:font-normal cursor-pointer">Contact Us</h1>
          </div>
        </div>
