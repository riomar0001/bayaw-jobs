                    ...
                    <>
                        <CardHeader className="border-b border-neutral-100 pb-6">
                            <div className="flex items-center gap-4">
                                <div>
                                    <h1 className="text-xl md:text-2xl font-bold text-gray-800">{jobData.title}</h1>
                                    <div className="flex items-center gap-2 text-neutral-500">
                                        <Building size={16} className="text-lochmara-400" />
                                        <span className="font-medium">Company Name</span>
                                        <span className="text-xs text-neutral-400">• Posted {new Date(jobData.created_at).toLocaleDateString()}</span>
                                    </div>
                                </div>
                            </div>
                        </CardHeader>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12 mb-8">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-neutral-600">₱{jobData.salary_from} - ₱{jobData.salary_to}</p>
                                    </div>
                                </div>
