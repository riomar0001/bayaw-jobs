...
export default function EmployerForgotPasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Employer password reset requested for:", email);
    // Simulate API call
    setTimeout(() => {
      setIsSubmitted(true);
    }, 500);
  ...
  if (isSubmitted) {
    return (
      <AuthFormLayout
        ...
        description="We've sent password reset instructions to your work email"
      >
  ...
  return (
    <AuthFormLayout
      ...
      description="Enter your work email and we'll send you instructions to reset your password"
    >
